...
import PinnedMessagesModal from "./components/PinnedMessagesModal.jsx";
    ...
    return (
        <div className={"h-14 border-b border-gray-200 flex items-center px-4 justify-between bg-white"}>
            ...
            <div className={"flex items-center gap-3"}>
                ...
                <button className={"hover:bg-[#f8f8f8] p-1 rounded"} onClick={handleVideoCall} title="Start Video Call">
